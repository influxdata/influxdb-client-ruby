...
### Features
1. [#96](https://github.com/influxdata/influxdb-client-dart/pull/96): Add support for Parameterized Queries

### Documentation
1. [#96](https://github.com/influxdata/influxdb-client-dart/pull/96): Add Parameterized Queries example
